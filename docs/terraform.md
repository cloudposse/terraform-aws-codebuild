...
| secondary\_sources | A list of maps, that contain secondary repository parameters for the build | <pre>list(object(<br>    {<br>      git_clone_depth  = number<br>      location = string<br><br>      git_submodules_config = string<br><br>      source_identifier = string<br><br>      type = string<br>  }))</pre> | <pre>""</pre> | no |
